...
/*
 * CREATE BY XZY;
 * DESIGNED FOR DATABASE ENCODING
 * MADE IN 2018-09-11
 * MY OWN BLOG WWW.TEENSHARE.CLUB
 * */
public class MD5Code {
	 ...
	 * 四个链接变量
	 */
	private final int A = 0x67452303;
	...
	public static void main(String[] arg) {
			String a = JOptionPane.showInputDialog("请输入文字：");
			MD5Code md5Code = new MD5Code();
			System.out.println(md5Code.getMD5(a));
	}
}
